...
Repositório de um projeto pessoal de estudo. Treino engenharia de software no problema real da produção de eventos, cronograma, quem sobe e quanto custa, no mesmo painel.
...
Quem produz o Sábado Maldito precisa do próximo evento, do custo de cachê e de quem sobe, com horário. O Vue organiza o que a API já decide.
